...
echo color("green","______________Welcome______________ \n\n");
echo color("yellow"," github : ");
echo color("red","Wildan Fauzi \n");
echo color("blue","___________________________________\n\n");

// function change(){
        $nama = nama();
        $email = str_replace(" ", "", $nama) . mt_rand(100, 999);
        ulang:
        echo color("nevy","[?] Masukkan Nomor (yang belum regis akun gojek) (628xxx): ");
        ...
        echo color("blue","\n__________(REDEEM VOUCHER)__________\n");
        for($a=1;$a<=3;$a++){
        echo color("yellow",".");
        sleep(1);
        }
